                    ...
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <form action="index.php?action=login_admin" method="post">
                            <div class="form-floating mb-3">
                                <input type="text" name="name" required class="form-control" id="floatingInput" placeholder="name@example.com" value="">
                                <label for="floatingInput">Username</label>
                                
                            </div>
                            <div class="form-floating mb-4">
                                <input type="password" name="pass" required class="form-control" id="floatingPassword" placeholder="Password">
